class Version < Formula
  ...
  url "https://github.com/AlexBurnes/version-go/releases/download/v1.5.0/version-0.5.9-darwin-amd64.tar.gz"
  sha256 "PLACEHOLDER_SHA256"
  license "Apache-2.0"
  
  if Hardware::CPU.arm?
    url "https://github.com/AlexBurnes/version-go/releases/download/v1.5.0/version-0.5.9-darwin-arm64.tar.gz"
