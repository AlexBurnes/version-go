class Version < Formula
  ...
  url "https://github.com/AlexBurnes/version/releases/download/v0.5.4/version-0.5.4-darwin-amd64.tar.gz"
  sha256 "PLACEHOLDER_SHA256"
  license "Apache-2.0"
  
  if Hardware::CPU.arm?
    url "https://github.com/AlexBurnes/version/releases/download/v0.5.4/version-0.5.4-darwin-arm64.tar.gz"
